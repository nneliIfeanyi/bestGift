...
<body class="w3-serif body" style="scroll-behavior:smooth;">
	...
	<div class="search w3-light-grey w3-row-padding w3-leftbar w3-rightbar w3-border-black">
	...
	?>
		...
		<!-- Commerce SECTION -->
			...
			?>
				...
				<div class="w3-row-padding w3-center w3-card-2 w3-margin" style="background-color:rgba(0, 0, 0, 0.95);">
			 ...
			 <div id="showCUPS" class=""  style="display: none;">
			   ...
			   <div class="">
			    	...
			    	<?php
			    		...
			    		<div class="w3-row-padding w3-center w3-card-2 w3-margin w3-black">

			    			<div class="w3-half w3-text-red w3-padding-large" style="background-color:rgba(0, 0, 0, 0.95);">
			    				<h2>No goods to display for now, check again later.</h2>
			    			</div>
