...
<body class="w3-serif body">
	...
	<div class="box w3-card-4 w3-padding-16 w3-margin-top" style="background-color:rgba(0, 0, 0, 0.95);color: antiquewhite;">
		<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
	          

			<div class="w3-row-padding">

				<p class="w3-large w3-text-orange w3-center"><i>Input the quantity you would like to purchase then proceed.</i></p>
				...
				<div class="title-img w3-padding-16">
					...
					<img src="admin/<?=$img?>" class="w3-circle" height="200px" width="50%">
				</div>
				...
				<div class="w3-third w3-center">
					...
					<h1 class="w3-xlarge w3-text-orange">Input Quantity</h1>
				...
				<div class="w3-third w3-center">
					...
					<h1 class="w3-xlarge"><b>Price :</b>&nbsp;<span class="w3-large w3-text-light-grey">&#8358;<?=$price?></span><span class="w3-tiny w3-text-orange">each</span></h1>
