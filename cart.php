	        ...
	        <table class="w3-table-all">
	          ...
	          <tbody>
	            ...
	            <tr class="w3-text-dark-grey">
	              ...
	              <td class="w3-tiny"><?php  echo $description; ?></td>
	              ...
	              <a href="checkout.php?amt=<?=$amount?>&id=<?=$id?>&title=<?=$title?>&describe=<?=$description?>&price=<?=$price?>&img=<?=$img?>" class="w3-text-green w3-tiny">Buy Now</a></td>
